...
{(properties?.length===0)&&<> <div className='w-full h-96 text-2xl text-neutral-800 font-medium flex justify-center items-center flex-col '>no Properties yet<div className='text-base font-normal text-neutral-500'>Please create a listing first first</div></div>
  </>}
